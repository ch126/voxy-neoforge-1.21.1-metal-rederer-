...
public class BasicSectionGeometryData implements IGeometryData {
    ...
    public BasicSectionGeometryData(int maxSectionCount, long geometryCapacity) {
        ...
        this.sectionMetadataBuffer = RenderBackendFactory.get()
                .createBuffer((long) maxSectionCount * SECTION_METADATA_SIZE);
        ...
        if (!Capabilities.INSTANCE.isNvidia) {
            buffer = RenderBackendFactory.get().createBuffer(geometryCapacity, 0, false);
